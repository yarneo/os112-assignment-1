...
main(int argc, char *argv[])
{
  ...
  25:	e8 fe 03 00 00       	call   428 <mkdir>
  ...
  42:	c7 44 24 04 a5 08 00 	movl   $0x8a5,0x4(%esp)
  49:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 49a:	f7 f7                	div    %edi
 49c:	0f b6 92 c8 08 00 00 	movzbl 0x8c8(%edx),%edx
...
putc(int fd, char c)
{
 ...
 710:	e9 30 fe ff ff       	jmp    545 <printf+0x35>
        ...
        ap++;
        if(s == 0)
 715:	bf c1 08 00 00       	mov    $0x8c1,%edi
...
free(void *ap)
{
 ...
 721:	a1 e4 08 00 00       	mov    0x8e4,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 76f:	89 08                	mov    %ecx,(%eax)
  freep = p;
 771:	a3 e4 08 00 00       	mov    %eax,0x8e4
}
 776:	5b                   	pop    %ebx
 777:	5e                   	pop    %esi
 778:	5f                   	pop    %edi
 ...
 79b:	89 10                	mov    %edx,(%eax)
    ...
    p->s.ptr = bp;
  freep = p;
 79d:	a3 e4 08 00 00       	mov    %eax,0x8e4
}
 7a2:	5b                   	pop    %ebx
 7a3:	5e                   	pop    %esi
 7a4:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 7b9:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if((prevp = freep) == 0){
 7bc:	8b 0d e4 08 00 00    	mov    0x8e4,%ecx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 7e4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    if(p == freep)
 7e8:	3b 05 e4 08 00 00    	cmp    0x8e4,%eax
 ...
 807:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 80a:	89 0d e4 08 00 00    	mov    %ecx,0x8e4
      return (void*) (p + 1);
...
morecore(uint nu)
{
 ...
 84c:	e8 cf fe ff ff       	call   720 <free>
  return freep;
 851:	8b 0d e4 08 00 00    	mov    0x8e4,%ecx
      }
      freep = prevp;
      return (void*) (p + 1);
    }
 ...
 864:	eb a4                	jmp    80a <malloc+0x5a>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 866:	c7 05 e4 08 00 00 dc 	movl   $0x8dc,0x8e4
 86d:	08 00 00 
    base.s.size = 0;
 870:	b9 dc 08 00 00       	mov    $0x8dc,%ecx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 875:	c7 05 dc 08 00 00 dc 	movl   $0x8dc,0x8dc
 87c:	08 00 00 
    base.s.size = 0;
 87f:	c7 05 e0 08 00 00 00 	movl   $0x0,0x8e0
 886:	00 00 00 
