...
main(void)
{
  ...
  19:	e8 72 03 00 00       	call   390 <open>
  ...
  2d:	e8 96 03 00 00       	call   3c8 <dup>
  dup(0);  // stderr
  32:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  39:	e8 8a 03 00 00       	call   3c8 <dup>
  3e:	66 90                	xchg   %ax,%ax
  ...
  bf:	e8 c4 02 00 00       	call   388 <exec>
      printf(1, "init: exec sh failed\n");
...
stat(char *n, struct stat *st)
{
 ...
 2af:	e8 dc 00 00 00       	call   390 <open>
  if(fd < 0)
...
stat(char *n, struct stat *st)
{
 ...
 2c4:	e8 df 00 00 00       	call   3a8 <fstat>
  close(fd);
 ...
 2cc:	89 c6                	mov    %eax,%esi
  close(fd);
 2ce:	e8 a5 00 00 00       	call   378 <close>
  return r;
}
...
gets(char *buf, int max)
{
 ...
 314:	e8 4f 00 00 00       	call   368 <read>
    if(cc < 1)
...
putc(int fd, char c)
{
 ...
 466:	e8 05 ff ff ff       	call   370 <write>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
...
putc(int fd, char c)
{
 ...
 53d:	e8 2e fe ff ff       	call   370 <write>
 ...
 55a:	e8 11 fe ff ff       	call   370 <write>
...
putc(int fd, char c)
{
 ...
 58d:	e8 de fd ff ff       	call   370 <write>
...
putc(int fd, char c)
{
 ...
 5fd:	e8 6e fd ff ff       	call   370 <write>
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
...
putc(int fd, char c)
{
 ...
 630:	e8 3b fd ff ff       	call   370 <write>
...
putc(int fd, char c)
{
 ...
 684:	e8 e7 fc ff ff       	call   370 <write>
...
morecore(uint nu)
{
 ...
 7b9:	e8 1a fc ff ff       	call   3d8 <sbrk>
  if(p == (char*) -1)
