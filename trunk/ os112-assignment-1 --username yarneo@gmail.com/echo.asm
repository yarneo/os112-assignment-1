...
main(int argc, char *argv[])
{
  ...
  28:	c7 44 24 0c 8e 08 00 	movl   $0x88e,0xc(%esp)
  2f:	00 
  30:	8b 44 9f fc          	mov    -0x4(%edi,%ebx,4),%eax
  34:	83 c3 01             	add    $0x1,%ebx
  37:	c7 44 24 04 90 08 00 	movl   $0x890,0x4(%esp)
  3e:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 49a:	f7 f7                	div    %edi
 49c:	0f b6 92 9e 08 00 00 	movzbl 0x89e(%edx),%edx
...
putc(int fd, char c)
{
 ...
 710:	e9 30 fe ff ff       	jmp    545 <printf+0x35>
        ...
        ap++;
        if(s == 0)
 715:	bf 97 08 00 00       	mov    $0x897,%edi
...
free(void *ap)
{
 ...
 721:	a1 b8 08 00 00       	mov    0x8b8,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 76f:	89 08                	mov    %ecx,(%eax)
  freep = p;
 771:	a3 b8 08 00 00       	mov    %eax,0x8b8
}
 776:	5b                   	pop    %ebx
 777:	5e                   	pop    %esi
 778:	5f                   	pop    %edi
 ...
 79b:	89 10                	mov    %edx,(%eax)
    ...
    p->s.ptr = bp;
  freep = p;
 79d:	a3 b8 08 00 00       	mov    %eax,0x8b8
}
 7a2:	5b                   	pop    %ebx
 7a3:	5e                   	pop    %esi
 7a4:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 7b9:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if((prevp = freep) == 0){
 7bc:	8b 0d b8 08 00 00    	mov    0x8b8,%ecx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 7e4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    if(p == freep)
 7e8:	3b 05 b8 08 00 00    	cmp    0x8b8,%eax
 ...
 807:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 80a:	89 0d b8 08 00 00    	mov    %ecx,0x8b8
      return (void*) (p + 1);
...
morecore(uint nu)
{
 ...
 84c:	e8 cf fe ff ff       	call   720 <free>
  return freep;
 851:	8b 0d b8 08 00 00    	mov    0x8b8,%ecx
      }
      freep = prevp;
      return (void*) (p + 1);
    }
 ...
 864:	eb a4                	jmp    80a <malloc+0x5a>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 866:	c7 05 b8 08 00 00 b0 	movl   $0x8b0,0x8b8
 86d:	08 00 00 
    base.s.size = 0;
 870:	b9 b0 08 00 00       	mov    $0x8b0,%ecx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 875:	c7 05 b0 08 00 00 b0 	movl   $0x8b0,0x8b0
 87c:	08 00 00 
    base.s.size = 0;
 87f:	c7 05 b4 08 00 00 00 	movl   $0x0,0x8b4
 886:	00 00 00 
