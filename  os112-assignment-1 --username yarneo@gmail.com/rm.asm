...
main(int argc, char *argv[])
{
  ...
  25:	e8 e6 03 00 00       	call   410 <unlink>
  ...
  exit();
  38:	e8 7b 03 00 00       	call   3b8 <exit>
  ...
  42:	c7 44 24 04 a2 08 00 	movl   $0x8a2,0x4(%esp)
  49:	00 
...
main(int argc, char *argv[])
{
  ...
  if(argc < 2){
    printf(2, "Usage: rm files...\n");
  60:	c7 44 24 04 8e 08 00 	movl   $0x88e,0x4(%esp)
  67:	00 
  68:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
  6f:	e8 9c 04 00 00       	call   510 <printf>
    exit();
  74:	e8 3f 03 00 00       	call   3b8 <exit>
  79:	90                   	nop
  7a:	90                   	nop
  7b:	90                   	nop
  7c:	90                   	nop
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 49a:	f7 f7                	div    %edi
 49c:	0f b6 92 c2 08 00 00 	movzbl 0x8c2(%edx),%edx
...
putc(int fd, char c)
{
 ...
 710:	e9 30 fe ff ff       	jmp    545 <printf+0x35>
        ...
        ap++;
        if(s == 0)
 715:	bf bb 08 00 00       	mov    $0x8bb,%edi
...
free(void *ap)
{
 ...
 721:	a1 dc 08 00 00       	mov    0x8dc,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 76f:	89 08                	mov    %ecx,(%eax)
  freep = p;
 771:	a3 dc 08 00 00       	mov    %eax,0x8dc
}
 776:	5b                   	pop    %ebx
 777:	5e                   	pop    %esi
 778:	5f                   	pop    %edi
 ...
 79b:	89 10                	mov    %edx,(%eax)
    ...
    p->s.ptr = bp;
  freep = p;
 79d:	a3 dc 08 00 00       	mov    %eax,0x8dc
}
 7a2:	5b                   	pop    %ebx
 7a3:	5e                   	pop    %esi
 7a4:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 7b9:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if((prevp = freep) == 0){
 7bc:	8b 0d dc 08 00 00    	mov    0x8dc,%ecx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 7e4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    if(p == freep)
 7e8:	3b 05 dc 08 00 00    	cmp    0x8dc,%eax
 ...
 807:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 80a:	89 0d dc 08 00 00    	mov    %ecx,0x8dc
      return (void*) (p + 1);
...
morecore(uint nu)
{
 ...
 84c:	e8 cf fe ff ff       	call   720 <free>
  return freep;
 851:	8b 0d dc 08 00 00    	mov    0x8dc,%ecx
      }
      freep = prevp;
      return (void*) (p + 1);
    }
 ...
 864:	eb a4                	jmp    80a <malloc+0x5a>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 866:	c7 05 dc 08 00 00 d4 	movl   $0x8d4,0x8dc
 86d:	08 00 00 
    base.s.size = 0;
 870:	b9 d4 08 00 00       	mov    $0x8d4,%ecx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 875:	c7 05 d4 08 00 00 d4 	movl   $0x8d4,0x8d4
 87c:	08 00 00 
    base.s.size = 0;
 87f:	c7 05 d8 08 00 00 00 	movl   $0x0,0x8d8
 886:	00 00 00 
