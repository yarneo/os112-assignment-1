...
putc(int fd, char c)
{
 ...
 3b6:	e8 f5 fe ff ff       	call   2b0 <write>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
...
putc(int fd, char c)
{
 ...
 48d:	e8 1e fe ff ff       	call   2b0 <write>
 ...
 4aa:	e8 01 fe ff ff       	call   2b0 <write>
...
putc(int fd, char c)
{
 ...
 4dd:	e8 ce fd ff ff       	call   2b0 <write>
...
putc(int fd, char c)
{
 ...
 54d:	e8 5e fd ff ff       	call   2b0 <write>
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
...
putc(int fd, char c)
{
 ...
 580:	e8 2b fd ff ff       	call   2b0 <write>
...
putc(int fd, char c)
{
 ...
 5d4:	e8 d7 fc ff ff       	call   2b0 <write>
...
morecore(uint nu)
{
 ...
 709:	e8 0a fc ff ff       	call   318 <sbrk>
  if(p == (char*) -1)
